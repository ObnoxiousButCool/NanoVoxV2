...
describe('OverviewPage', () => {
  ...
  describe('where we stand', () => {
    it('leads with the week, not with the all-time total', async () => {
      ...
      const trend = await screen.findByRole('heading', { name: 'Overall Call Quality & Average Handling Time' })
  ...
  describe('quality vs handling time', () => {
    it('draws a point on each line for every week that measured it', async () => {
      ...
      await screen.findByRole('heading', { name: 'Overall Call Quality & Average Handling Time' })
    ...
    it("labels a point by its own week even in Month mode, since Month only narrows which weeks come back", async () => {
      ...
      const heading = await screen.findByRole('heading', { name: 'Overall Call Quality & Average Handling Time' })
      const card = heading.closest('section')
